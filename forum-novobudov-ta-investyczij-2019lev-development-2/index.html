        ...
        <div class="swiper-container" data-options='{"speed": 800, "parallax":true, "customFraction":true}'>
            <div class="swiper-wrapper">
                    ...
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_1.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                            <div class="swiper-slide">
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_2.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                            <div class="swiper-slide">
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_3.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                            <div class="swiper-slide">
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_4.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                            <div class="swiper-slide">
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_5.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                            <div class="swiper-slide">
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_6.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                            <div class="swiper-slide">
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_7.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                            <div class="swiper-slide">
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_8.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                            <div class="swiper-slide">
                    <div class="image simple-slide-image">
                        <div class="bg-full" data-bg="https://evil-lev.tech/wp-content/uploads/2019/11/fn_9.jpg" data-swiper-parallax="30%"></div>
                    </div>
                </div>
                        </div>
                ...
                <div class="row anime">
                    <div class="col-lg-10 offset-lg-2 fade-anime">
                        <div class="blog-detail-layout">
                            <div class="prev-next">
                                                                    <a class="btn btn-lg prev" href="https://evil-lev.tech/start-budivnycztva-zhk-hygge148/"><span>попередня новина<span class="ar"></span></span></a>
                                                                                                    <a class="btn btn-lg next" href="https://evil-lev.tech/kupuj-vygidno-zrostannya-czin-u-zhk-hygge148/"><span>наступна новина<span class="ar"></span></span></a>
                                                            </div>
                        </div>
                    </div>
                </div>
