...
<body class="page-template page-template-page-hotel2 page-template-page-hotel2-php page page-id-3070 language-en">
                        ...
                        <div class="full-size t-overflow">
                            ...
                            <div class="content">
                                ...
                                <div class="t-overflow">
                                    <div class="subtitle text-anime delay2">The first online hotel in Lviv to work for you</div>
                                </div>
                            </div>
                            
                             
                                <a class="btn btn-simple btn-simple-icon right-b flatrisbutton" href="#" data-flatris-id="e2wa90QM90rXLAN">
                                        <i class="icon">
                ...
                <div class="row anime">
                    <div class="col-xl-10 offset-xl-1">
                        <h2 class="t-move h2 block-title style2 lettering line-left-2">
                            <span>EARN MONEY</span> <span>ON LEISURE OF OTHERS</span>                         </h2>
                    </div>
                    <div class="col-xl-8 offset-xl-3">
                        <div class="spacer-sm"></div>
                        <div class="t-overflow">
                            <article class="article text-md two-column color-grey w-regular text-anime delay2">
                                <p>Privately owned room are a new investment for Ukraine, but a profitable and reliable investment.  The hotel's good location near the city center, as well as its first-class service, guarantees a high and stable income during the first months of operation.</p>
                            </article>
                        </div>
                        <div class="spacer-sm"></div>
                        <div class="t-overflow">
                            <div class="table-item text-anime delay3">
                                <div class="cell">
                                    ...
                                    <div class="desc">Under construction</div>
                                </div>
                                <div class="cell">
                                    <div class="title">Address:</div>
                                    <div class="desc">Lviv, Shevchenko st., 73</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container custom">
                <div class="row no-gutters anime">
                    <div class="col-lg-4 align-self-center">
                        <h2 class="t-move h2 block-title style2 lettering line-left-2">
                            <span>7 REASONS</span> <span>CHOOSE Lviv</span>                         </h2>
                                ...
                                <div class="text-anime">
                                    ...
                                    <div class="text text-md w-thin color-optional">
                                        <p>Ribas Hotels Group is a national hotel operator that will manage LEV Resort Hotel. Ribas Hotels Group manages and develops city hotels, resort hotels and apartment hotels. Ensures stable occupancy of hotels and returns on investors' investments by developing investment projects. Ribas Hotels Group will be responsible for complex management of apartments and providing first-class service to guests.</p>
                                                        ...
                                                        <div class="item-benefit t-overflow anime">
                                <div class="text-anime">
                                    <h4 class="h4 title">More than 100 festivals</h4>
                                    <div class="count text-sm">02.</div>
                                    <div class="text text-md w-thin color-optional">
                                        <p>Each festival = from 20 000 people from cities of Ukraine and other countries.</p>
                                    </div>
                                </div>
                            </div>
                                                        <div class="item-benefit t-overflow anime">
                                <div class="text-anime">
                                    <h4 class="h4 title">2+ million tourists annually</h4>
                                    <div class="count text-sm">03.</div>
                                    <div class="text text-md w-thin color-optional">
                                        <p>Lviv is one of the few tourist cities in Europe, with a nice value for money.</p>
                                    </div>
                                </div>
                            </div>
                                                        <div class="item-benefit t-overflow anime">
                                <div class="text-anime">
                                    <h4 class="h4 title">Prices for tourist services</h4>
                                    ...
                                    <div class="text text-md w-thin color-optional">
                                        <p>Lviv is one of the few tourist cities in Europe, with a nice value for money.</p>
                                                        ...
                                                        <div class="item-benefit t-overflow anime">
                                <div class="text-anime">
                                    <h4 class="h4 title">Convenient transport connections</h4>
                                    <div class="count text-sm">05.</div>
                                    <div class="text text-md w-thin color-optional">
                                        <p>It is equally convenient to get to Lviv, both from cities of Ukraine and from Europe.  For most travelers, this is a must-visit city.</p>
                                    </div>
                                </div>
                            </div>
                                                        <div class="item-benefit t-overflow anime">
                                <div class="text-anime">
                                    <h4 class="h4 title">Traditional and varied cuisine</h4>
                                    <div class="count text-sm">06.</div>
                                    <div class="text text-md w-thin color-optional">
                                        <p>Many tourists come to Lviv for so-called gastro-tours.  This city prides itself on many establishments where you can enjoy restaurant fare at affordable prices.</p>
                                    </div>
                                </div>
                            </div>
                                                        <div class="item-benefit t-overflow anime">
                                <div class="text-anime">
                                    <h4 class="h4 title">500 km to Kiev, Warsaw and Budapest</h4>
                                    <div class="count text-sm">07.</div>
                                    <div class="text text-md w-thin color-optional">
                                        <p>Lviv is located at the same distance from the 3 capitals.  Therefore, residents of these cities often choose it for vacation.</p>
                                    </div>
                                </div>
                            </div>
                                                    </div>
            ...
            <div class="container custom">
                <div class="row anime">
                    ...
                    <div class="col-md-6 col-xl-4 offset-xl-1 d-flex align-self-center justify-content-xl-center">
                        <div class="t-overflow">
                            <div class="subtitle w1 text-anime">
                                Stay up-to-date on all LEV CITY HOTEL construction work                            </div>
                        </div>
                ...
                <div class="swiper-container" data-initial-last="true" data-options='{"speed": 800, "watchSlidesVisibility":true, "dynamicBullets":true,  "slidesPerView": 3, "spaceBetween": 10, "breakpoints":{ "1199":{"slidesPerView": 2}, "767":{"slidesPerView": 1} }}'>
                    <div class="swiper-wrapper">
                            ...
                            <a href="https://evil-lev.tech/wp-content/uploads/2024/04/1.jpg" class="bw-image lightbox">
                                ...
                                <div class="desc text-sm">April 2024</div>
                            </a>
...
<ul>
<li>Extract from the State Register of Real Property Rights on the registration of another real right dated 10/16/2019 № 185006882</li>
<li>Extract from the State Register of Real Property Rights on the registration of another real right from 10/16/2019 № 185008096</li>
<li>Extract from the State Register of Real Property Rights on the registration of another real right dated 10/16/2019 № 185009091</li>
</ul>
<p><strong>Cadastral number of the land plot:</strong></p>
<ul>
<li>4610136300: 02: 004: 0009</li>
</ul>
                                                    </div>
                                                </div>
                                                                                    </div>
...
<ul>
<li>Permission for construction works of the LV series № 112200231105 from January 2020</li>
</ul>
<p><strong>Urban planning conditions and restrictions:</strong></p>
<ul>
<li>Decision of the Executive Committee № 1025 dated November 1, 2019</li>
</ul>
                                                    </div>
                                                </div>
                                                                                    </div>
...
<form action="/en/lev-city-hotel/#wpcf7-f395-o1" method="post" class="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
...
<p>For 6 months &#8211; without any overpayments, pegged to the dollar.</p>
                                ...
                                <div class="text alert-text text-lg w-thin">* the maximum installment period depends on the planned date of delivery of the object, you can learn more detailed calculation from our sales manager</div>
                             </div>
            <button class="btn-close"></button>
        </div>
    </div>
